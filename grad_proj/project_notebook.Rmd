...
# Ran out of time on this -- I didn't need to do grouping by and summarizing to perform the analyses I did because summing row-wise served a similar function for the way my data was structured that grouping/summarizing would have if the data had been structured differently. My fault for not remebering/making sure I was incorporating some kind of analysis that required a group by and summarize, though.
