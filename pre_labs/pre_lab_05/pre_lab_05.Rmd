...
- The first row got incorrectly read in as the header column
- unwanted periods and spaces in the region names
...
- remove unwanted periods and spaces from the region names
