...
https://www.datawrapper.de/_/cfD8B/
...
md_gov_county <- md_gov_county %>%
  mutate(county_total = rowSums(md_gov_county[,3:8])) %>%
  mutate(moore_pct = Moore/county_total*100)
...
The color palette has been updated to greens and blues. 
...
https://www.datawrapper.de/_/A7dyZ/
