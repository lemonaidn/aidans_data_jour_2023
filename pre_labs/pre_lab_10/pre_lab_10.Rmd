...
It displays md_county_notices (if we commented thhat line out it would display md_county_population instead)
...
", Maryland" has been removed from the county col, title case has been applied, and extra whitespace has been trimmed
...
The colors of some of the counties changed. This is a positive change because the prior scale included levels that no county fell within
```{r}
ggplot() +
  geom_sf(data=md_pop_with_foreclosures, aes(fill=rate)) +
  theme_minimal() +
