...
Very similar grantees, who probably represent the same individual grantee in real life, aren't being grouped together because they have minor differences in their names. For example:
...
It uppercased The Tree House Child Advocacy Center
Charles County Arts Alliance Inc turned into CHARLES COUNTY ARTS ALLIANCE
Melwood Horticultural Training Center, Inc. turned into Melwood Horticultural Training Center
...
Only one change in the first 30 results:

WASHINGTON ADVENTIST UNIVERSITY -> Washington Adventist University

Two changes in the next 10 results:

WASHINGTON CO COMM. ACTION COUNCIL INC -> 	WASHINGTON COMM ACTION COUNCIL
...
cleaned_md_grant_loans |>
  ...
  filter(str_detect(Grantee, '^w|^W')) |>
  arrange(Grantee) |>
  mutate(name_unchanged = Grantee == grantee_clean)
```
...
No, it doesn't appear to vary substantially based on the first 40 results
